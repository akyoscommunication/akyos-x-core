...
namespace Akyos\Core\ACF\CustomFields\StyleSelectorField;
 ...
 * Register field name
 */
const FIELD_NAME = 'StyleSelector';
const FIELD_TYPE = 'style_selector';
 ...
 */
if (!class_exists('App\Acf\CustomFields\StyleSelector\RegisterCustomField')) {
    return;
}
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->settings = array(
            ...
            'slug'        => 'style-selector',
            'version'     => VERSION,
            'url'         => get_home_url() . '/app/themes/akyos-sage/app/Acf/CustomFields/StyleSelectorField',
            'path'        => __DIR__
        );
