...
namespace Akyos\Core\ACF\CustomFields\GradientColorPicker;
 ...
 * Register field name
 */
const FIELD_NAME = 'GradientColorPicker';
const FIELD_TYPE = 'gradient_color_picker';
 ...
 */
if (!class_exists('App\Acf\CustomFields\GradientColorPicker\RegisterCustomField')) {
    return;
}
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->settings = array(
            ...
            'slug'        => 'gradient-color-picker',
            'version'     => VERSION,
            'url'         => get_home_url() . '/app/themes/akyos-sage/app/Acf/CustomFields/GradientColorPickerField',
            'path'        => __DIR__
        );
